...
MORDOR_RUNTIME_LINK_DECLARATION(WinHttpDetectAutoProxyConfigUrl, BOOL, WINAPI, (DWORD, LPWSTR *));
MORDOR_RUNTIME_LINK_DECLARATION(WinHttpOpen, HINTERNET, WINAPI, (LPCWSTR, DWORD, LPCWSTR, LPCWSTR, DWORD));
MORDOR_RUNTIME_LINK_DECLARATION(inet_pton, INT, WSAAPI, (INT, PCSTR, PVOID));
}
